...
def log_validation_batch(vae, text_encoder_one, text_encoder_two, tokenizer_one, tokenizer_two, flux_transformer, reference_unet, noise_scheduler, subject_noise, train_transforms, args, accelerator, weight_dtype, epoch, batch_text_prompts, batch_origin_text_prompts, 
batch_subject_prompt, batch_img_paths, batch_variation_num, clip_model, clip_processor):
    ...
    pipeline = load_pipelines(vae, text_encoder_one, text_encoder_two, tokenizer_one, tokenizer_two, flux_transformer, noise_scheduler, weight_dtype, args)
...
def load_pipelines(vae, text_encoder_one, text_encoder_two, tokenizer_one, tokenizer_two, flux_transformer, noise_scheduler, weight_dtype, args):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % args.checkpointing_steps == 0:
                    ...
                    unwrapped_flux_transformer.save_pretrained(save_path, torch_dtype=torch.float16, is_main_process=accelerator.is_main_process, max_shard_size='50GB', safe_serialization=False)
