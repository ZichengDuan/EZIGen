...
accelerate launch --config_file accelerate_configs/$CONFIG_FILE train.py --config configs/train_config.yaml
# python train_sdxl.py --config configs/train_config_sdxl.yaml