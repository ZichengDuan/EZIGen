...
from models.reference_unet.attention_processor_ref import Attention_ref
...
class GatedSelfAttentionDense(nn.Module):
    ...
    def __init__(self, query_dim: int, context_dim: int, n_heads: int, d_head: int):
        ...
        self.attn = Attention_ref(query_dim=query_dim, heads=n_heads, dim_head=d_head)
...
@maybe_allow_in_graph
class BasicTransformerBlock_ref(nn.Module):
    r"""
