...
from models.main_unet.transformer_2d_main import Transformer2DModel_main
...
def get_down_block(
    ...
    if down_block_type == "DownBlock2D":
        ...
        return CrossAttnDownBlock2D_main(
            num_layers=num_layers,
...
def get_mid_block(
    ...
    if mid_block_type == "UNetMidBlock2DCrossAttn":
        return UNetMidBlock2DCrossAttn_main(
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            temb_channels=temb_channels,
            dropout=dropout,
...
def get_up_block(
    ...
    if up_block_type == "UpBlock2D":
        ...
        return CrossAttnUpBlock2D_main(
            num_layers=num_layers,
            transformer_layers_per_block=transformer_layers_per_block,
            in_channels=in_channels,
            out_channels=out_channels,
...
class UNetMidBlock2DCrossAttn_main(nn.Module):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
...
class CrossAttnDownBlock2D_main(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class CrossAttnUpBlock2D_main(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
