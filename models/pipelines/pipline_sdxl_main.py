...
class StableDiffusionXLPipeline_main(
    DiffusionPipeline,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if (
            self.denoising_end is not None and isinstance(self.denoising_end, float) and self.denoising_end > 0 and self.denoising_end < 1
        ):
