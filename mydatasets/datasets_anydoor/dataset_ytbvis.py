...
class YoutubeVISDataset_unet_sdxl(BaseDataset_unet):
...
class YoutubeVISDataset_unet_sd21(BaseDataset_unet):
    def __init__(self, image_dir, anno, meta, sub_size, transforms, ytbvis_subset_size=40000, args = None, tokenizer=None):
        self.image_root = image_dir
        self.anno_root = anno 
        self.meta_file = meta
